...
public class p38_AceptarEstudianteV2 {
    public static void main(String[] args) {
        ...
        switch (sexo) {
            case 'H': System.out.print("Introduce tu edad...");  
            case 'M': System.out.print("Lo sentimos la escuela solo admite a hombres...:"); 
            edad = obj.nextInt();
            
            if (edad < 21) { 
                System.out.println("Lo sentimos la escuela solo acepta a mayores de 21...");}
            else if(edad >= 21) 
